...
function Card(props: CardProps) {
    ...
    const { image, name, speciality, hospital } = props
...
const formatData = (data: CardProps[]) => {
    ...
    data.map((item, i) => {
        ...
        const from_time = moment(item[current_day + "_from"], "HH:mm:ss")

        // Get the "to" time of the doctor
        const to_time = moment(item[current_day + "_to"], "HH:mm:ss")
...
export default function HeaderCarousel() {
    ...
    useEffect(() => {
        ...
        API.get("/doctors?populate=*").then((response) => {
            ...
            setData(formatData(response.data.docs))
        })
    }, [])
